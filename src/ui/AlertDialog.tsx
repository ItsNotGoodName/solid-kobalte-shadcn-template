...
export function AlertDialogOverlay(
  props: ComponentProps<typeof AlertDialog.Overlay>,
) {
...
export function AlertDialogTitle(
  props: ComponentProps<typeof AlertDialog.Title>,
) {
  const [_, rest] = splitProps(props, ["class"]);
  return (
    <AlertDialog.Title
...
export function AlertDialogDescription(
  props: ComponentProps<typeof AlertDialog.Description>,
) {
  const [_, rest] = splitProps(props, ["class"]);
  return (
    <AlertDialog.Description
      class={cn("overflow-y-auto text-sm text-muted-foreground", props.class)}
      {...rest}
    />
  );
}
...
export function AlertDialogCancel(
  props: ComponentProps<typeof AlertDialog.CloseButton>,
) {
  const [_, rest] = splitProps(props, ["class"]);
  return (
