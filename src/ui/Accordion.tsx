...
export function AccordionItem(props: ComponentProps<typeof Accordion.Item>) {
  ...
  return <Accordion.Item class={cn("border-b", props.class)} {...rest} />;
}

export function AccordionTrigger(
  props: ComponentProps<typeof Accordion.Trigger>,
) {
...
export function AccordionContent(
  props: ComponentProps<typeof Accordion.Content>,
) {
  const [_, rest] = splitProps(props, ["class", "children"]);
  return (
    <Accordion.Content
      class="overflow-hidden text-sm transition-all ui-expanded:animate-accordion-down ui-not-expanded:animate-accordion-up"
      {...rest}
    >
