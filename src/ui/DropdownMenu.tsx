...
export function DropdownMenuSubTrigger(
  props: ComponentProps<typeof DropdownMenu.SubTrigger> & { inset?: boolean },
) {
...
export function DropdownMenuSubContent(
  ...
  return (
    <DropdownMenu.SubContent
      class={cn(
        "z-50 min-w-[8rem] max-w-[var(--kb-popper-content-available-width)] origin-[var(--kb-menu-content-transform-origin)] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-lg ui-expanded:animate-in ui-expanded:fade-in-0 ui-expanded:zoom-in-95 ui-not-expanded:animate-out ui-not-expanded:fade-out-0 ui-not-expanded:zoom-out-95",
        props.class,
      )}
      {...rest}
    />
...
export function DropdownMenuItem(
  props: ComponentProps<typeof DropdownMenu.Item> & { inset?: boolean },
) {
...
export function DropdownMenuCheckboxItem(
  props: ComponentProps<typeof DropdownMenu.CheckboxItem> & { inset?: boolean },
) {
...
export function DropdownMenuRadioItem(
  props: ComponentProps<typeof DropdownMenu.RadioItem> & { inset?: boolean },
) {
...
export function DropdownMenuGroupLabel(
  props: ComponentProps<typeof DropdownMenu.GroupLabel> & { inset?: boolean },
) {
  const [_, rest] = splitProps(props, ["class", "inset"]);
  return (
